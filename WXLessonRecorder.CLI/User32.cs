...
namespace WXLessonRecorder.CLI
{
    public static class User32
    {
		...
		public static readonly int HWND_TOP = 0; //在前面
		public static readonly int HWND_BOTTOM = 1; //在后面
		public static readonly int HWND_TOPMOST = -1; //在前面, 位于任何顶部窗口的前面
		public static readonly int HWND_NOTOPMOST = -2; //在前面, 位于其他顶部窗口的后面
//uFlags 参数可选值:
		public static readonly int SWP_NOSIZE = 0x1; //忽略 cx、cy, 保持大小
		public static readonly int SWP_NOMOVE = 0x2; //忽略 X、Y, 不改变位置
		public static readonly int SWP_NOZORDER = 0x4; //忽略 hWndInsertAfter, 保持 Z 顺序
		public static readonly int SWP_NOREDRAW = 0x8; //不重绘
		public static readonly int SWP_NOACTIVATE = 0x10; //不激活
		public static readonly int SWP_FRAMECHANGED = 0x20; //强制发送 WM_NCCALCSIZE 消息, 一般只是在改变大小时才发送此消息
		public static readonly int SWP_SHOWWINDOW = 0x40; //显示窗口
		public static readonly int SWP_HIDEWINDOW = 0x80; //隐藏窗口
		public static readonly int SWP_NOCOPYBITS = 0x100; //丢弃客户区
		public static readonly int SWP_NOOWNERZORDER = 0x200; //忽略 hWndInsertAfter, 不改变 Z 序列的所有者
		public static readonly int SWP_NOSENDCHANGING = 0x400; //不发出 WM_WINDOWPOSCHANGING 消息
		public static readonly int SWP_DRAWFRAME = SWP_FRAMECHANGED; //画边框
        public static readonly int SWP_NOREPOSITION = SWP_NOOWNERZORDER;
		public static readonly int SWP_DEFERERASE = 0x2000; //防止产生 WM_SYNCPAINT 消息
		public static readonly int SWP_ASYNCWINDOWPOS = 0x4000; //若调用进程不拥有窗口, 系统会向拥有窗口的线程发出需求
        [DllImport("user32.dll", SetLastError = true)]
